...
export default function Projects() {
  ...
  return (
    <main className="min-h-screen px-6 py-20 bg-gray-50 dark:bg-gray-900 scroll-mt-24">
      ...
      >
        <FaDesktop size={50} className="text-blue-600 dark:text-blue-400 mb-4" />
      ...
      >
        {projects.map((p, i) => (
          <div
            key={i}
            className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-700 p-6 flex flex-col overflow-hidden hover:shadow-2xl transition"
          >
            {/* Titre & description */}
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-3">{p.title}</h2>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {p.tech.map((t, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1 bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-300 text-sm rounded-full shadow-sm"
                >
                  {t}
                </span>
              ))}
            ...
            <a
              ...
              className="mt-auto flex items-center justify-center gap-2 bg-blue-600 dark:bg-blue-500 text-white py-3 rounded-lg shadow hover:bg-blue-700 dark:hover:bg-blue-600 transition"
            >
