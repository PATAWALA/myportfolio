      ...
      >
        ...
        >
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <Lottie animationData={devAnimation} loop className="w-[250px] sm:w-[300px] md:w-[400px] lg:w-[500px]" />
          </div>
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0 text-center md:text-left space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-4">
              <a href="#projects" className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition">
                Voir mes réalisations →
              </a>
              <a href="/assets/mypdfportfolio.pdf" download className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 dark:bg-green-500 text-white rounded-lg shadow-md hover:bg-green-700 transition">
